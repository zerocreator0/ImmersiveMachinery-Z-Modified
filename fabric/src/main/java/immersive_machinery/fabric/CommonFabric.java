...
import immersive_machinery.fabric.inventory.FabricInventoryAccess;
...
public final class CommonFabric implements ModInitializer {
    ...
    public void onInitialize() {
        // Use the Fabric Transfer API for inventory access (Sophisticated Storage, etc.)
        InventoryAccessHolder.set(new FabricInventoryAccess());
